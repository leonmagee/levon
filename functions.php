...
function levon_register_post_types()
{
...
add_action('init', 'levon_register_post_types');
...
function register_menus()
{
    ...
    register_nav_menus(
        array(
            'primary-nav' => _('Main Nav Menu'), // add locations here.
        )
    );
}
...
function html5_blank_view_article($more)
{
    ...
    return '... <a class="view-article" href="' . get_permalink($post->ID) . '">' . __('View Tutorial', 'html5blank') . '</a>';
}
